...
const Details = () => {
  return (
    <Stack width={{ lg: "50%", md: "50%", sm: "100%", xs: "100%" }} spacing={4}>
      <Typography component={'li'} typeof="bullet" sx={styles.text}>I’m Divyanshu Sharma, a passionate Frontend Developer with over 1.5+ years of experience in building <b style={{ color: "#64FFDA" }}>responsive, scalable web applications using React.js, TypeScript, and Django REST Framework.</b></Typography>
